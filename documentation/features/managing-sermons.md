...
1. Navigate to Messages → Scripture
...
1. Navigate to Messages → Seasons
...
1. Navigating to Messages → All Messages
...
2. Click "Quick Edit"
3. Modify sermon details including the sermon start timestamp
