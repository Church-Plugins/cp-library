...
**Solutions**:
1. Verify that your site doesn't have caching that prevents tracking scripts from loading
...
2. Consider limiting the number of revisions stored for sermon posts
