...
export const PlayOverlayWrapper = ({ item, onClick }) => {
	...
	return (
		<div className='cpl-play-btn-overlay' onClick={handleClick}>
			{
				isVideo ?
				<svg xmlns="http://www.w3.org/2000/svg" width="25%" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-play">
					<polygon points="5 3 19 12 5 21 5 3"/>
				</svg> :
				<svg xmlns="http://www.w3.org/2000/svg" width="25%" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-volume-2">
...
function PlayIcon({ item }) {
	...
	return (
		<PlayOverlayWrapper item={item} onClick={handleClick} />
	)
}
