    ...
    public function should_be_visible($post_id) {
        ...
        try {
            ...
            foreach ($item_types as $item_type) {
                $item_type_id = $item_type['origin_id'];
                if (get_post_meta($item_type_id, 'exclude_from_main_list', true)) {
                    return false;
                }
            }
            ...
            foreach ($service_types as $service_type) {
                $service_type_id = $service_type['origin_id'];
                if (get_post_meta($service_type_id, 'exclude_from_main_list', true)) {
                    return false;
                }
            }
