...
return array(
	...
	<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cp-library/item-title {"level":3,"isLink":true,"style":{"typography":{"fontSize":"1.5rem","fontStyle":"normal","fontWeight":"400","textTransform":"uppercase"}}} /-->
	...
	<div class="wp-block-group" style="margin-top:8px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cp-library/sermon-speaker {"style":{"spacing":{"padding":{"top":"4px","bottom":"4px","left":"8px","right":"8px"}},"border":{"width":"0px","style":"none"}}} /-->

	<!-- wp:cp-library/item-date {"style":{"spacing":{"padding":{"top":"4px","bottom":"4px","left":"0px","right":"0px"},"margin":{"bottom":"0","left":"0","right":"0","top":"0px"}}}} /--></div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group" style="margin-top:16px;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cp-library/sermon-topics {"style":{"spacing":{"padding":{"top":"4px","bottom":"4px","left":"8px","right":"8px"}},"border":{"color":"#ebeced","width":"1px"}}} /-->

	<!-- wp:cp-library/sermon-series {"style":{"spacing":{"padding":{"top":"4px","bottom":"4px","left":"8px","right":"8px"}},"border":{"color":"#ebeced","width":"1px"}}} /-->

	<!-- wp:cp-library/sermon-scripture {"style":{"border":{"color":"#ebeced","width":"1px"},"spacing":{"padding":{"top":"4px","bottom":"4px","left":"8px","right":"8px"}}}} /--></div>
	<!-- /wp:group --></div>
	<!-- /wp:group --></div>
	<!-- /wp:group -->
