...
return array(
	...
	<div class="wp-block-group" style="margin-top:8px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cp-library/item-date /--></div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cp-library/sermon-scripture {"style":{"border":{"color":"#e5e8ef","width":"1px"},"spacing":{"padding":{"top":"4px","bottom":"4px","left":"8px","right":"8px"}}}} /--></div>
	<!-- /wp:group --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->
