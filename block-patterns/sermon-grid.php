...
return array(
	...
	'content'    => '<!-- wp:cp-library/query {"queryId":2,"query":{"perPage":"6","pages":0,"offset":0,"postType":"cpl_item","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"include":[],"sticky":"","inherit":false,"taxQuery":null,"cpl_speakers":null,"cpl_service_types":null,"parents":[]},"displayLayout":{"type":"flex","columns":2},"layout":{"type":"constrained"}} -->
	<div class="wp-block-cp-library-query"><!-- wp:cp-library/sermon-template {"style":{"spacing":{"padding":{"top":"0","bottom":"0"}}}} -->
	<!-- wp:group {"style":{"spacing":{"padding":{"left":"24px","right":"24px","top":"24px","bottom":"24px"}},"color":{"background":"#f0f0f0"},"dimensions":{"minHeight":"100%"},"border":{"radius":"8px"}},"layout":{"inherit":true}} -->
	...
	<!-- wp:cp-library/item-title {"level":3,"isLink":true,"style":{"spacing":{"margin":{"top":"16px"}}},"fontSize":"medium"} /-->
